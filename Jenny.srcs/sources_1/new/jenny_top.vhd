...
begin
    ...
    dp: datapath port map(clk => clkn, reset => reset, instr => instr, addr => addr, addrnext => addrnext, sw => SW,
    ...
    pcCLK: flipFlop generic map(16) port map(clk => clkn, reset => reset, d => addrnext, q => addr);
